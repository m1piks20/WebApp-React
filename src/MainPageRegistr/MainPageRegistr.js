...
import './MainPageRegistr.css'; // Подключаем CSS стили
import { Link } from 'react-router-dom';
import defaultAvatar from "../MemoryPage/img/avatar.png";




function MainPageRegistr() {
            ...
            <div className="container">
                ...
                <div className="card">
                    ...
                    <div className="card-info">
                        <p className="card-title">Фамилия <br/>Имя Отчество</p>
                        <p className="card-date">1724-2024</p>
                    </div>
                </div>

                <Link to="/MemoryPage" className="btn-create">
                    <p className="plus">+</p>
                </Link>
            </div>
...
export default MainPageRegistr;
